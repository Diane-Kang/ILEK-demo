...
class ILEKdemo
{
  ...
  ?>
    <label class="selectit"><input type="radio" name="media_for_gallery_box_buttons" value="ja" <?php echo $value == 'ja' ? 'checked' : ''; ?>>
      Ja</label>
    </br>
    <label class="selectit"><input type="radio" name="media_for_gallery_box_buttons" value="nein" <?php echo $value == 'nein' ? 'checked' : ''; ?>>
      Nein</label>
  <?php
  }
...
<?php }
  ...
  //////end-------------------------------- Rest API /wp-json/ILEK-demo/infojson

  /////-------------------------------- Rest API /wp-json/ILEK-demo/galleryjson
  ...
  /////end-------------------------------- Rest API /wp-json/ILEK-demo/geojson
