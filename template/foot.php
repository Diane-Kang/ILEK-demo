  ...
  <div class="popup info " id="geeting_info_popup">
    ...
    <div class="content_wrapper">
      ...
      <div class="slide one show">
        ...
        <div class="right">
          <!-- <div class="wappen_wrapper">
                        <div class="wappen">
                            <img src="/wp-content/plugins/ILEK-demo/assets/Wappen_von_Fellen.svg"
                                alt="Gemeinde Fellen Wappen">
                            <p>Gemeinde Fellen</p>

                        </div>
                        <div class="wappen">
                            <img src="/wp-content/plugins/ILEK-demo/assets/SA_logo_vollton_blau.svg"
      ...
      <!-- <div class="slide two">
                ...
                <img src="/wp-content/plugins/ILEK-demo/assets/screen111.png"
            ...
            <div class="slide three">
                ...
                <img src="/wp-content/plugins/ILEK-demo/assets/screen222.jpeg"
                    alt="Screenshot zur Bedienung der Datenbank: Übersichtsseite">
                <p>
            ...
            <div class="slide four">
                ...
                <img src="/wp-content/plugins/ILEK-demo/assets/screen_two.jpeg"
                    alt="Screenshot zur Bedienung der Datenbank: Übersichtsseite">
                <p>
