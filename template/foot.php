  ...
  <div class="popup info " id="geeting_info_popup">
    ...
    <div class="content_wrapper">
      ...
      <div class="slide one show">
        <div>
          <div class="branding">
            <!-- <a href="https://page-effect.de/"> 
                        <img
                                src="/wp-content/plugins/ILEK-demo/assets/logo-2023.png" alt="Page Effect"></a></div> -->
            ...
            <p>
              ...
              Testphase</p>
            <p> Sollten Sie Interesse an einer Kartenanwendung für Ihr Projekt haben, schreiben Sie bitte
              gerne an:
